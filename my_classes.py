...
class DataSet:
    ...
    def load_data_frames(self, SAMPLE_SIZE_USERS=None, ARR_ORDERS_ID=None):
        ...
        orders = pd.read_hdf(IDIR + 'orders.hdf', 'orders')

        print('loading prior')
        priors = pd.read_hdf(IDIR + 'priors.hdf', 'priors')

        print('loading train')
        train = pd.read_hdf(IDIR + 'train.hdf', 'train')

        print('loading products')
        products = pd.read_hdf(IDIR + 'products.hdf', 'products')
